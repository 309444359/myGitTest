package com.bluemobi.mavenTest.jvm.classloader;
...
public class MyClassLoader extends ClassLoader {
	...
	public static void test1()  throws ClassNotFoundException, InstantiationException, IllegalAccessException {
		...
		String name = "com.bluemobi.mavenTest.jvm.classloader.MyClassLoader";
		
		Object obj = myClassLoader.loadClass(name).newInstance();
		
		Object obj2 = Class.forName("com.bluemobi.mavenTest.jvm.classloader.MyClassLoader").newInstance();
