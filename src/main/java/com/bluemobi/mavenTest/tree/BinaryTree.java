package com.bluemobi.mavenTest.tree;
...
public class BinaryTree {  
    ...
    public void createBinTree(TreeNode root){  
        ...
        newNodeC.setRightChild(newNodeG);
        
        newNodeG.setLeftChild(newNodeH);
    }  
    ...
    //前序遍历的非递归实现  
    public Stack<TreeNode> nonRecPreOrder(TreeNode p){  
    ...
    public static void main(String[] args) {  
        ...
        Stack<TreeNode> stack = bt.nonRecPreOrder(bt.root);  
